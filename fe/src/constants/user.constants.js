...
export const LOGIN_WITH_TOKEN_REQUEST = "USER_LOGIN_WITH_TOKEN_REQUEST";
export const LOGIN_WITH_TOKEN_SUCCESS = "USER_LOGIN_WITH_TOKEN_SUCCESS";
export const LOGIN_WITH_TOKEN_FAIL = "USER_LOGIN_WITH_TOKEN_FAIL";
